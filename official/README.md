...
`logos.pdf` 已随模板提供，普通 LaTeX 编译不需要 LibreOffice 或 Python。PDF 保留附件内四幅图像的原始像素，按 Word 显示尺寸组合；西安交通大学图像沿用原件的右侧裁剪量 71.548%，显示校徽。
...
当前随附 `logos.pdf` 的 SHA-256 为 `b6f61aeab178805a468595ee823e38ffabcf7c00809513c3717335547379c688`。原始附件的 SHA-256 见 [核对记录](../docs/FORMAT-AUDIT.md)。重新导出时 PDF 文档标识可能变化，不要求再生文件与当前文件逐字节相同。
